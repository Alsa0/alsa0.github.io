...
function renderProjects(filter) {
  ...
  filtered.forEach((project, index) => {
    ...
    const icons = {
      reseaux: '<i class="fa-solid fa-network-wired" font-size:3rem;"></i>',
      cloud: '<i class="fa-solid fa-cloud" font-size:3rem;"></i>',
      securite: '<i class="fa-solid fa-shield-halved" font-size:3rem;"></i>',
      voip: '<i class="fa-solid fa-phone" font-size:3rem;"></i>',
      dev: '<i class="fa-solid fa-code" font-size:3rem;"></i>',
    };
